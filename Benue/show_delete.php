    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row" style="transition: 0.5s ease all;">
                   ...
                   <div class="row">
                        <div class="col-md-12">
                            <center>
                                ...
                                <div class="latests">
                                   <?php
                                        $sql = mysqli_query($con,"SELECT * FROM blog WHERE unique_id = '$session_id' ");
                                        while($rows = mysqli_fetch_assoc($sql)){
                                            $table_id = $rows['id'];
                                            $inserted_id = $rows['unique_id'];
                                        
                                   ?>
                                    <div class="posts" style="padding: 20px; border: 5px solid white;">
                                         <div class="post-owner">
                                            <img src="php/img/<?php echo $rows['profile']; ?>">
                                            <p><?php echo $rows['name']; ?></p>
                                            <p><?php echo $rows['dates']; ?></p>
                                        </div>
                                        <div class="post-content">
                                        <img src="php/blog/<?php echo $rows['img']; ?>"><br><br>
                                        <p><?php echo $rows['message']; ?></p>
                                        </div>
                                        <form method="POST">
                                            <input type='hidden' value='<?php echo $table_id; ?>' name='id'>
                                            <input type='hidden' value='<?php echo $inserted_id; ?>' name='unique_id'>
                                            <input type='submit' value='Delete Post' class='btn btn-danger' name='del'>
                                        </form>
                                        <?php
                                        }
                                        if (isset($_POST['del'])) {
                                          ...
                                          $sql2 = mysqli_query($con,"DELETE FROM blog WHERE id='$id' ");
                                          if($sql2){
               ...
               <div class="post-blog" style="margin-top: 30px;">
                   
                            <div class="row">
                                <div class="col-md-4">

                                </div>
                                <div class="col-md-4"> <h4 style="text-align: center;">Create New Post!!</h4>
