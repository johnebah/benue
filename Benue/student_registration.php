                   ...
                   <div class="row">
                       ...
                       <div class="col-md-6">
                           <div class="register_border">
                               <form action="#">
                                <p class='warning' style="text-align:center; color:red; font-weight:bolder; font-size:20px;"></p>
                                ...
                                <p><input type="text" placeholder="Matric No." name="matric" class="form-control" ></p>
                                <p><input type="password" placeholder="Password" name="password" class="form-control"></p>
                                <p><input type="password" placeholder="Confirm password" name="cpassword" class="form-control"></p>
                                <p><input type="text" placeholder="Enter Moblie no." name="mobile" class="form-control"></p>
                                <p><input type="checkbox" name=""><label for="info">Agree to our terms and condition</label></p>
                                <div class="subber">
                                    <p><input onclick="Register()" type="submit" value="REGISTER" name="" class="btn btn-danger btn-lg register_button" style="width: 100%; font-size: 20px; font-weight: bolder;"></p>
                                    
                                </div>
                                
                            </form>
                            <p style="text-align: center;font-weight: bolder;font-size: 20px;">Already registered?&nbsp;<a href="student_login.php">Proceed login</a></p>
                           </div>
