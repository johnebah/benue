            ...
            <div class="row" style="transition: 0.5s ease all;">
               ...
               <section id="dashboard-page">
                   <div class="row">
                       ...
                       <div class="col-md-4">
                            <center>
                                <div class="table-statu">
                                    <!-- <table>
                                    <tr>
                                        <td>Name:</td><td>Adole Michael Joe</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Email:</td><td>goingtod@bsum.com</td>
                                    </tr>
                                    <tr>
                                        <td>Gender:</td><td>Male</td>
                                    </tr>
                                    <tr>
                                        <td>Date of birth:</td><td>4-05-1999</td>
                                    </tr>
                                    <tr>
                                        <td>Phone No.:</td><td>02044845465656</td>
                                    </tr>
                                </table> -->
                                </div>
                        ...
                        <div class="col-md-4">
                            <center>
                                <div class="register_border" style="margin-top: 30px;">
                                    <form action="#" enctype='multipart/form-data'>
                                    <p class='warning' style="text-align:center; color:red; font-weight:bolder; font-size:20px;" required></p>
                                    <p><input type="email" placeholder="New mail" class="form-control" name="email"></p>
                                    <p><input type="password" placeholder="New password" class="form-control" name="password"></p>
                                    <p><input type="password" placeholder="Confirm New password" class="form-control" name="cpassword"></p>
                                    <p><input type="text" placeholder="Gender" class="form-control" name="gender"></p>
                                    <p><input type="text" placeholder="Department" class="form-control" name="department"></p>
                                    <p><input type="text" placeholder="Course" class="form-control" name="course"></p>
                                    <p><input type="date" placeholder="" class="form-control" name="date"></p>
                                    <p><input type="file" class="form-control" name="profile"></p>
                                    <p><input type="text" placeholder="New Phone No." class="form-control" name="mobile"></p>
                                        <div class="subber">
                                        <p><input onclick="Register()" type="submit" value="UPDATE PROFILE" name="" class="btn btn-danger btn-lg register_button" style="width: 100%; font-size: 20px; font-weight: bolder;"></p>
