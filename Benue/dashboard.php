                       ...
                       <div class="col-md-4">
                           <center>
                            <div class="left-dashboard">
                               <!-- <img src="img/bsu logo.jpg" alt="Profile pic" id='profile'>
                               <p id='matric'>BSU/BM/NUR/18/1515</p>
                               <span id='namer'>Adole Michael Joe</span> -->
                            </div>
                        </center>
                       ...
                       <div class="col-md-4">
                            <center>
                                <div class="table-status">
                                    ...
                                    <tr>
                                        <td>Department:</td><td>Physiology</td>
                                    </tr>
                                    <tr>
                                        <td>Course</td><td>B.sc Human physiology</td>
                                    </tr>
                                    <tr>
