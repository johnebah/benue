                       ...
                       <div class="col-md-6">
                           <div class="register_border">
                               ...
                               <p class='warning' style="text-align:center; color:red; font-weight:bolder; font-size:20px;"></p>
                                ...
                                <div class="subber">
                                    <p><input onclick="Register()" type="submit" value="LOGIN" name="" class="btn btn-danger btn-lg register_button" style="width: 100%; font-size: 20px; font-weight: bolder;"></p>
                                   
                                </div>
                                 
                            </form>
                            <p style="text-align: center;font-weight: bolder;font-size: 20px;">Not yet registered?&nbsp;<a href="student_registration.php">Register Now</a></p>
                           </div>
