            ...
            <div class="row" style="transition: 0.5s ease all;">
                                ...
                                <!-- <div class="latests"> -->
                                    <!-- <div class="posts" style="padding: 20px; border: 5px solid white;"> -->
                                        <!-- <div class="post-owner">
                                            <img src="img/WhatsApp Image 2021-07-14 at 5.17.20 PM.jpeg">
                                            <p>Michael</p>
                                            <p>4 minutes ago</p>
                                        </div>
                                        <div class="post-content">
                                        <img src="img/bsu 1.png" alt="name"><br><br>
                                        <p>Bsu To Resume on monday soon</p>
                                        </div>
                                    </div>
                                    <div class='posts' style='padding: 20px; border: 5px solid white;'>
                                        <div class='post-owner'>
               ...
               <div class="post-blog" style="margin-top: 30px;">
                            ...
                            <div class="row">
                                ...
                                <p><input type="text" placeholder="Enter Message" class="form-control" name='message'></p>
                               <p><input type="file" name='img'></p> 
                                <p><button type="submit" class="btn btn-primary" onclick='Register()'>Upload Blog</button></p>
                                </form>
                                </div>
                                <div class="col-md-4">
